...
$(lineage-sdk-test-coverage-report): PRIVATE_REDBIRD_SDK_API_COVERAGE_EXE := $(lineage_sdk_api_coverage_exe)
...
$(lineage-sdk-test-coverage-report): $(lineage_sdk_tests_apk) $(lineagesettingsprovider_tests_apk) $(lineage_sdk_api_coverage_dependencies) | $(ACP)
	$(call generate-lineage-coverage-report,"REDBIRD-SDK API Coverage Report",\
...
define generate-lineage-coverage-report
	$(hide) mkdir -p $(dir $@)
	$(hide) $(PRIVATE_REDBIRD_SDK_API_COVERAGE_EXE) -d $(PRIVATE_DEXDEPS_EXE) -a $(PRIVATE_API_XML_DESC) -f $(3) -o $@ $(2) -cm
	@ echo $(1): file://$@
endef
