...
ALARM_PATH := vendor/redbird/prebuilt/common/media/audio/alarms
NOTIFICATION_PATH := vendor/redbird/prebuilt/common/media/audio/notifications
RINGTONE_PATH := vendor/redbird/prebuilt/common/media/audio/ringtones
